...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor: "#f59e0b", padding: 5, borderRadius: 5, margin: 5 },
  ...
  orderButton: { backgroundColor: "#f59e0b", paddingVertical: 10, paddingHorizontal: 20, borderRadius: 8 },
