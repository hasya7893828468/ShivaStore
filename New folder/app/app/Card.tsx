      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View style={styles.container}>
          ...
          <Image
            source={{
              uri: product.img
                ? `http://192.168.144.2:5001/${product.img.replace(/^\/+/, "")}`
...
const styles = StyleSheet.create({
  ...
  backButton: { position: "absolute", top: 20, left: 20, backgroundColor: "#f59e0b", padding: 8, borderRadius: 20 },
  ...
  addButton: { backgroundColor: "#f59e0b", paddingVertical: 12, paddingHorizontal: 20, borderRadius: 10, alignItems: "center" },
